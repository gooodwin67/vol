...
export class Engine {
  ...
  moveOpponent() {
    ...
    if (ballClass.ball.position.distanceTo(playersData.opponentShootMark.position) < 1 && playersData.opponentTapShoot && !playersData.opponentFly && !playersData.opponentJumping) {
